...
<body class="bg-[#fffdf9] text-gray-800 flex flex-col min-h-screen">
  ...
  <nav class="bg-white border-b">
    <div class="max-w-7xl mx-auto flex items-center justify-center px-4 py-3">
      <div class="text-2xl font-bold font-serif tracking-wide text-gray-900">
        TUNué
      </div>
    </div>
  </nav>
  ...
  <nav class="bg-[#fefaf6] shadow-sm" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-2">
      <!-- KIRI: LOGIN -->
      <div>
        <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-black">Login</a>
      </div>

      <!-- KANAN (DESKTOP): Menu -->
      <ul class="hidden md:flex gap-6 text-sm font-medium text-gray-700 items-center">
    ...
    <div x-show="open" class="md:hidden bg-white border-t">
      <ul class="px-4 py-2 text-sm text-gray-700 space-y-2">
